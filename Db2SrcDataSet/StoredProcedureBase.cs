...
namespace Db2Source
{
	...
	{
		public StoredProcedureBase Owner { get; private set; }
		...
		public Parameter(StoredProcedureBase owner) : base()
		{
			Owner = owner;
	...
	public abstract class StoredProcedureBase : SchemaObject
	{
		public class ParameterCollection : IList<Parameter>, IList
		{
			private StoredProcedureBase _owner;
			...
			internal ParameterCollection(StoredProcedureBase owner)
			{
				_owner = owner;
		...
		protected abstract string RequireHeaderDef();
		//{
		//	if (_headerDef != null)
		//	{
		//		return;
		...
		{
			return new StoredProcecureBaseComment(Context, SchemaName, Name, GetInputParamTypes(), commentText, false);
		}

		private IDbCommand _dbCommand;
		internal IDbCommand RequireDbCommand()
		{
			if (_dbCommand != null)
			{
				return _dbCommand;
		...
		public IDbCommand DbCommand
		{
			get
			{
				return RequireDbCommand();
			}
		}

		//[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
		public StoredProcedureBase(Db2SourceContext context, string owner, string schema, string objectName, string definition, bool isLoaded) : base(context, owner, schema, objectName, NamespaceIndex.Objects)
		{
